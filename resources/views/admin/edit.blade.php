                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" id="nome" name="name" value="{{$admin->name}}" required>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="number" class="form-control" name="contacto" id="contacto" value="{{$admin->contacto}}" required>
