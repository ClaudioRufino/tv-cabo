"use strict";
$("#modeSwitcher").on("click",function(e){e.preventDefault(),modeSwitch(),location.reload()}),$(".collapseSidebar").on("click",function(e){$(".vertical").hasClass("narrow")?$(".vertical").toggleClass("open"):($(".vertical").toggleClass("collapsed"),$(".vertical").hasClass("hover")&&$(".vertical").removeClass("hover")),e.preventDefault()}),$(".sidebar-left").hover(function(){$(".vertical").hasClass("collapsed")&&$(".vertical").addClass("hover"),$(".narrow").hasClass("open")||$(".vertical").addClass("hover")},function(){$(".vertical").hasClass("collapsed")&&$(".vertical").removeClass("hover"),$(".narrow").hasClass("open")||$(".vertical").removeClass("hover")}),$(".toggle-sidebar").on("click",function(){$(".navbar-slide").toggleClass("show")}),function(a){a(".dropdown-menu a.dropdown-toggle").on("click",function(e){return a(this).next().hasClass("show")||a(this).parents(".dropdown-menu").first().find(".show").removeClass("show"),a(this).next(".dropdown-menu").toggleClass("show"),a(this).parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown",function(e){a(".dropdown-submenu .show").removeClass("show")}),!1})}(jQuery),$(".navbar .dropdown").on("hidden.bs.dropdown",function(){$(this).find("li.dropdown").removeClass("show open"),$(this).find("ul.dropdown-menu").removeClass("show open")}),$(".file-panel .card").on("click",function(){$(this).hasClass("selected")?($(this).removeClass("selected"),$(this).find("bg-light").removeClass("shadow-lg"),$(".file-container").removeClass("collapsed")):($(this).addClass("selected"),$(this).addClass("shadow-lg"),$(".file-panel .card").not(this).removeClass("selected"),$(".file-container").addClass("collapsed"))}),$(".close-info").on("click",function(){$(".file-container").hasClass("collapsed")&&($(".file-container").removeClass("collapsed"),$(".file-panel").find(".selected").removeClass("selected"))}),$(function(){$(".info-content").stickOnScroll({topOffset:0,setWidthOnStick:!0})});var basic_wizard=$("#example-basic");basic_wizard.length&&basic_wizard.steps({headerTag:"h3",bodyTag:"section",transitionEffect:"slideLeft",autoFocus:!0});var vertical_wizard=$("#example-vertical");vertical_wizard.length&&vertical_wizard.steps({headerTag:"h3",bodyTag:"section",transitionEffect:"slideLeft",stepsOrientation:"vertical"});var form=$("#example-form");form.length&&(form.validate({errorPlacement:function(e,a){a.before(e)},rules:{confirm:{equalTo:"#password"}}}),form.children("div").steps({headerTag:"h3",bodyTag:"section",transitionEffect:"slideLeft",onStepChanging:function(e,a,o){return form.validate().settings.ignore=":disabled,:hidden",form.valid()},onFinishing:function(e,a){return form.validate().settings.ignore=":disabled",form.valid()},onFinished:function(e,a){alert("Submitted!")}}));var ChartOptions={maintainAspectRatio:!1,responsive:!0,legend:{display:!1},scales:{xAxes:[{gridLines:{display:!1}}],yAxes:[{gridLines:{display:!1,color:colors.borderColor,zeroLineColor:colors.borderColor}}]}},



total_inscritos_1 = document.getElementById('total_inscritos_m_1').value,
total_inscritos_2 = document.getElementById('total_inscritos_m_2').value,
total_inscritos_3 = document.getElementById('total_inscritos_m_3').value,
total_inscritos_4 = document.getElementById('total_inscritos_m_4').value,
total_inscritos_5 = document.getElementById('total_inscritos_m_5').value,
total_inscritos_6 = document.getElementById('total_inscritos_m_6').value,
total_inscritos_7= document.getElementById('total_inscritos_m_7').value,
total_inscritos_8 = document.getElementById('total_inscritos_m_8').value,
total_inscritos_9 = document.getElementById('total_inscritos_m_9').value,
total_inscritos_10 = document.getElementById('total_inscritos_m_10').value,
total_inscritos_11 = document.getElementById('total_inscritos_m_11').value,
total_inscritos_12 = document.getElementById('total_inscritos_m_12').value,


inscritos_janeiro = document.getElementById('inscritos_m_1').value,
inscritos_fevereiro = document.getElementById('inscritos_m_2').value,
inscritos_marco = document.getElementById('inscritos_m_3').value,
inscritos_abril = document.getElementById('inscritos_m_4').value,
inscritos_maio = document.getElementById('inscritos_m_5').value,
inscritos_junho = document.getElementById('inscritos_m_6').value,
inscritos_julho = document.getElementById('inscritos_m_7').value,
inscritos_agosto = document.getElementById('inscritos_m_8').value,
inscritos_setembro = document.getElementById('inscritos_m_9').value,
inscritos_outubro = document.getElementById('inscritos_m_10').value,
inscritos_novembro = document.getElementById('inscritos_m_11').value,
inscritos_dezembro = document.getElementById('inscritos_m_12').value,

pagamento = document.getElementById('total_pagamento').value,
divida = document.getElementById('total_dividas').value,
multa = document.getElementById('total_multas').value,
pedido = document.getElementById('total_pedidos').value,

ChartData = {
    labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Out", "Nov", "Dez"], datasets: [{
        label: "Novos", barThickness: 10, backgroundColor: base.primaryColor, borderColor: base.primaryColor, pointRadius: !1, pointColor: "#3b8bba", pointStrokeColor: "rgba(60,141,188,1)", pointHighlightFill: "#fff", pointHighlightStroke: "rgba(60,141,188,1)",
        data: [inscritos_janeiro, inscritos_fevereiro, inscritos_marco, inscritos_abril, inscritos_maio, inscritos_junho, inscritos_julho, inscritos_agosto, inscritos_setembro, inscritos_outubro, inscritos_novembro, inscritos_dezembro], fill: "", lineTension: .1
    },

{label:"Clientes",barThickness:10,backgroundColor:"rgba(210, 214, 222, 1)",borderColor:"rgba(210, 214, 222, 1)",pointRadius:!1,pointColor:"rgba(210, 214, 222, 1)",pointStrokeColor:"#c1c7d1",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(220,220,220,1)",
data:[
    total_inscritos_1, total_inscritos_2, total_inscritos_3, total_inscritos_4, total_inscritos_5, total_inscritos_6, total_inscritos_7, total_inscritos_8, total_inscritos_9, total_inscritos_10, total_inscritos_11, total_inscritos_12
    ],

fill:"",borderWidth:2,lineTension:.1}]},lineChartData={labels:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep", "Out", "Nov", "Dez"], datasets:[{label:"Novos",barThickness:10,borderColor:base.primaryColor,pointRadius:!1,pointColor:"#3b8bba",pointStrokeColor:"rgba(60,141,188,1)",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(60,141,188,1)",data:[28,48,30,19,64,27,90,85,92], fill:"",lineTension:.2},

{label:"Sales",barThickness:10,borderColor:"rgba(40, 167, 69, 0.8)",pointRadius:!1,pointColor:"#3b8bba",pointStrokeColor:"rgba(60,141,188,1)",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(60,141,188,1)",data:[8,18,20,29,26,7,30,25,48],fill:"",borderWidth:2,lineTension:.2},{label:"Orders",backgroundColor:"rgba(210, 214, 222, 1)",borderColor:"rgba(210, 214, 222, 1)",pointRadius:!1,pointColor:"rgba(210, 214, 222, 1)",pointStrokeColor:"#c1c7d1",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(220,220,220,1)",data:[65,59,80,42,43,55,40,36,68],fill:"",borderWidth:2,lineTension:.2}]},

pieChartData={labels:["Pagamento","Divida","Multa","Pedido"], 
datasets:[{data:[pagamento, divida, multa, pedido],
    backgroundColor:chartColors,borderColor:colors.borderColor}]},areaChartData={labels:["Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],datasets:[{label:"Visitors",barThickness:10,backgroundColor:base.primaryColor,borderColor:base.primaryColor,pointRadius:!1,pointColor:"#3b8bba",pointStrokeColor:"rgba(60,141,188,1)",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(60,141,188,1)",data:[19,64,37,76,68,88,54,46,58],lineTension:.1},{label:"Orders",barThickness:10,backgroundColor:"rgba(210, 214, 222, 1)",borderColor:"rgba(255, 255, 255, 1)",pointRadius:!1,pointColor:"rgba(210, 214, 222, 1)",pointStrokeColor:"#c1c7d1",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(220,220,220,1)",data:[42,43,55,40,36,68,22,66,49],lineTension:.1}]},
