                ...
                <div class="row">
                  <div class="col-4">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                      ...
                      <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Atribuição de Dívidas</a>
                    </div>
                  </div>
                            ...
                            <table class="table mb-0">
                              <thead>
                                <tr>
                                  ...
                                  <th>Dia significativo</th>
                                  <th>Clientes Inativos</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  <td class="text-center"><?php echo e($sistema->multa); ?></td>
                                  <td class="text-center"><?php echo e($sistema->mensalidade); ?></td>
                                  <td class="text-center"><?php echo e($sistema->ativos); ?></td>
                                  <td class="text-center"><?php echo e($sistema->inativos); ?></td>
                                  <td class="text-center"><?php echo e($sistema->dia_significativo); ?></td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                      ...
                      <div class="tab-pane fade mb-4" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab"> 
                        <div class="col-12 bg-secondary">
                          <div class="row d-flex justify-content-center align-items-center p-4" style="background: #F8F8FF">
                            <form action="<?php echo e(route('sistema.update', 1)); ?>" method="POST">
                      ...
                      <div class="tab-pane fade mb-4" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="col-12">
                          <div class="row d-flex justify-content-center align-items-center p-4" style="background: #F8F8FF">
                            ...
                            <?php echo csrf_field(); ?>
                              <div class="form-group mb-3">
                                <label for="mensalidade text-center">Dia significativo de atribuição de dívidas</label>
                                <select class="form-control" id="valor_pagamento" name="dia_significativo">
