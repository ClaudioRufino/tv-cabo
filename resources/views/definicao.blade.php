                      ...
                      <div class="col-md-12">
                          <div class="">
                            <table class="table mb-0">
                              ...
                              <tbody>
                                <tr>
                                  <td class="text-center">{{$sistema->multa}}</td>
                                  <td class="text-center">{{$sistema->mensalidade}}</td>
                                  <td class="text-center">{{$sistema->ativos}}</td>
                                  <td class="text-center">{{$sistema->inativos}}</td>
                                  <td class="text-center">{{$sistema->dia_significativo}}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
