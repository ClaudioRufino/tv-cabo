    ...
    {{-- <form> --}}
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" id="linha" class="form-control" name="linha" value="{{$cliente->linha}}">
        </div>
      </div>
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <input class="form-control input-placeholde" id="data_contrato" type="date" name="data_contrato" value="{{$cliente->data_contrato}}" readonly>
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
          ...
          <select id="inputLang" class="form-control" name="num_casa">
            @for ($i = $cliente->num_casa; $i <= 500; $i++)
      ...
      <input type="hidden" name="avatar" id="avatar" value="{{$cliente->foto}}">
