...
<body>
    <main>
        ...
        <div class="corpo">
            ...
            <ul>
                <li>Código do cliente - <?php echo e($dados->id); ?></li>
                <li>Mes de Pagamento - <?php echo e($dados->mes); ?></li>
                <li>Ano de Pagamento - <?php echo e($dados->contacto); ?></li>
                <li>Data de Pagamento - <?php echo e($dados->data_pagamento); ?></li>
                <li>Atendimento por - <?php echo e($dados->atendido_por); ?></li>
                <br>
...
</html><?php /**PATH C:\Users\claud\OneDrive\Desktop\Projectos\tv-cabo\resources\views/pagamento/comprovativo.blade.php ENDPATH**/ ?>